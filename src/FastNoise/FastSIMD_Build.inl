...
FASTNOISE_REGISTER_NODE( Gradient );
...
FASTNOISE_REGISTER_NODE( SignedSquareRoot );
...
FASTNOISE_REGISTER_NODE( Slope );
FASTNOISE_REGISTER_NODE( Spheres );
FASTNOISE_REGISTER_NODE( Cylinders );
FASTNOISE_REGISTER_NODE( FractalErosion );
